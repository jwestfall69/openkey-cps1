...
// unless otherwise noted, raw values from mame should be used
// for -1 values in mame, use 0xff
typedef struct game_reg_t {
  uint8_t cps_id_addr;

  // if mame lists this as -1, it likely needs to be 0x0
...
game_reg game_regs[MAX_GAME_NUM+1] = {
  ...
  { 0xff, 0x0000,   0x06, 0x04, 0x02, 0x00,   0x0e, 0x0c, 0x0a,     0x20,      0x2e, 0x2c, 0x2a, 0x28,     0x30,      0x5, 0x4, 0x4, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 00000 [CCx ] CPS_B_21_BT3 Captain Commando (invalid layer mask data in mame)
  { 0xff, 0x0000,   0x1e, 0x1c, 0x1a, 0x18,   0xff, 0x0c, 0x0a,     0x20,      0x2e, 0x2c, 0x2a, 0x28,     0x30,      0x5, 0x3, 0x5, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 00001 [KDx ] CPS_B_21_BT2 The King of Dragons (invalid layer mask data in mame)
  { 0xff, 0x0000,   0x06, 0x04, 0x02, 0x00,   0x1e, 0x1c, 0x1a,     0x28,      0x26, 0x24, 0x22, 0x20,     0x30,      0x5, 0x4, 0x1, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 00010 [KRx ] CPS_B_21_BT4 Knights of the Round
  { 0xff, 0x0000,   0xff, 0xff, 0xff, 0xff,   0xff, 0xff, 0xff,     0x20,      0x2e, 0x2c, 0x2a, 0x28,     0x30,      0x5, 0x4, 0x4, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 00011 [Q5  ] CPS_B_21_BT6 Capcom World 2 (invalid layer mask data in mame)
  { 0xff, 0x0000,   0xff, 0xff, 0xff, 0xff,   0xff, 0xff, 0xff,     0x2c,      0xff, 0xff, 0xff, 0xff,     0x12,      0x4, 0x1, 0x4, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 00100 [QDx ] CPS_B_21_BT7 Quiz & Dragons (invalid layer mask data in mame)
  { 0x32, 0x0800,   0x0e, 0x0c, 0x0a, 0x08,   0x06, 0x04, 0x02,     0x28,      0x26, 0x24, 0x22, 0x20,     0x30,      0x5, 0x2, 0x3, 0x4, 0x4,   0x00, 0x00, 0x00 }, // 00101 [RTx ] CPS_B_21_BT1 Three Wonders (invalid layer mask data in mame)
  { 0x32, 0x0000,   0x0e, 0x0c, 0x0a, 0x08,   0x1e, 0x1c, 0x1a,     0x20,      0x2e, 0x2c, 0x2a, 0x28,     0x30,      0x5, 0x2, 0x1, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 00110 [VAx ] CPS_B_21_BT5 Varth

  // cps 1.5
  { 0xff, 0x0000,   0xff, 0xff, 0xff, 0xff,   0xff, 0x2e, 0x20,     0x0a,      0x0c, 0x0e, 0x00, 0x02,     0x04,      0x4, 0x4, 0x4, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 00111 [CDx ] CPS_B_21_QS2 Cadillacs & Dinosaurs (invalid layer mask data in mame)
  { 0x2e, 0x0c01,   0xff, 0xff, 0xff, 0xff,   0x1c, 0x1e, 0x08,     0x16,      0x00, 0x02, 0x28, 0x2a,     0x2c,      0x2, 0x3, 0x4, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 01000 [MBx ] CPS_B_21_QS4 Slam Masters / Muscle Bomber
  { 0x1e, 0x0c02,   0xff, 0xff, 0xff, 0xff,   0x0c, 0xff, 0xff,     0x2a,      0x2c, 0x2e, 0x30, 0x32,     0x1c,      0x2, 0x3, 0x4, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 01001 [MBDx] CPS_B_21_QS5 Muscle Bomber Duo
  { 0x0e, 0x0c00,   0xff, 0xff, 0xff, 0xff,   0x2c, 0xff, 0xff,     0x12,      0x14, 0x16, 0x08, 0x0a,     0x0c,      0x2, 0x1, 0x5, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 01010 [PSx ] CPS_B_21_QS3 Punisher
  { 0xff, 0x0000,   0xff, 0xff, 0xff, 0xff,   0xff, 0xff, 0xff,     0x22,      0x24, 0x26, 0x28, 0x2a,     0x2c,      0x4, 0x3, 0x2, 0x0, 0x0,   0x00, 0x00, 0x00 }, // 01011 [TK2 ] CPS_B_21_QS1 Warriors of Fate
